                ...
                <div class="container-fluid">
                    <div class="d-flex">
                        <a class="header-brand" href="index-1.html">
                            <img src="{{ asset('assets\images\brand\HOSPITAL.png') }}" class="header-brand-img" alt="adminor logo">
                        </a>
                        ...
                        <div class="d-flex order-lg-2 ml-auto header-right-icons header-search-icon">
                            ...
                            <div class="dropdown d-none d-md-flex ">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <ul class="drop-icon-wrap p-1">
                                        ...
                                        <li>
                                            <a href="{{ url('/doctor/logout') }}" class="drop-icon-item">
                            ...
                            <div class="dropdown text-center selector">
                                <a href="#" class="nav-link leading-none" data-toggle="dropdown">
                                    <span class="avatar avatar-sm brround cover-image" data-image-src="assets/images/faces/male/6.jpeg"></span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
