                    ...
                    <ul class="list-unstyled components" id="accordion">
                        <div class="user-profile">
                            <div class="dropdown user-pro-body">
                                <div><img src="{{-- {{ asset('images/backend_images/doctors_images/'.$doc->image) }} --}}" alt="user-img" class="img-circle"></div>
                                <div class="mb-2"><a href="#" class="" data-toggle="" aria-haspopup="true" aria-expanded="false"> <span class="font-weight-semibold">{{-- {{ $doc->first_name }} {{ $doc->last_name }} --}}</span> </a>
                                    <br><span class="text-gray">{{-- {{ $doc->field }} --}}</span>
                                </div>
                            </div>
                        </div>
                        <li class="">
                        ...
                        <li class="">
                            <a href="#Apps" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
                                <i class="fa fa-snowflake-o mr-2"></i> Doctors
                            </a>
                            <ul class="collapse list-unstyled" id="Apps" data-parent="#accordion">
                                <li>
                                    <a href="{{ url('/doctor/add-doctor') }}">Add Doctor</a>
                                </li>
                                <li>
                                    <a href="{{ url('/doctor/view-doctors') }}">View Doctors</a>
                                </li>
                                {{-- <li>
                        ...
                        <li>
                            <a href="#pageSubmenu" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fa fa-area-chart mr-2"></i> Intern</a>
                            <ul class="collapse list-unstyled" id="pageSubmenu" data-parent="#accordion">
                                <li>
                                    <a href="chart-chartist.html">Add Interns </a>
                                </li>
                                <li>
                                    <a href="chart-dygraph.html">View Interns</a>
                                </li>
                                {{-- <li>
                                ...
                                {{-- <li class="secondlevel">
                                    <a href="#Submenu4" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">Patients</a>
                                    <ul class="collapse list-unstyled" id="Submenu4">
                                        <li>
                                            <a href="charts.html">Add Patients</a>
                                        </li>
                                        <li>
                                            <a href="chart-line.html">View Patients</a>
                                        </li>
                                        <li>
                        ...
                        <li class="">
                            <a href="#Uielements" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
                                <i class="mdi mdi-buffer mr-2"></i>Fields/Specialization
                            </a>
                            <ul class="collapse list-unstyled" id="Uielements" data-parent="#accordion">
                                <li>
                                    <a href="{{ url('/fields/add-medical-fields') }}">Add Fields</a>
                                </li>
                                <li>
                                    <a href="{{ url('/fields/view-fields') }}">View Fields</a>
                                </li>
                                {{-- <li>
                        ...
                        <li class="">
                            <a href="#Uidesign" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
                                <i class="fa fa-tachometer mr-2"></i> Patients
                            </a>
                            <ul class="collapse list-unstyled" id="Uidesign" data-parent="#accordion">
                                <li>
                                    <a href="accordion.html">Add Patients</a>
                                </li>
                                <li>
                                    <a href="tabs.html">View Patients</a>
                                </li>
                        ...
                        <li class="">
                            <a href="#Forms" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
                                <i class="mdi mdi-arrange-send-backward mr-2"></i> Tags/Referances
                            </a>
                            <ul class="collapse list-unstyled" id="Forms" data-parent="#accordion">
                                <li>
                                    <a href="{{ url('/reference') }}">Add Tag</a>
                                </li>
                                <li>
                                    <a href="{{url('/view-tags')}}">View Tags</a>
                                </li>
